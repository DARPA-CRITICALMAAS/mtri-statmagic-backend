...
def vector_proximity_raster_upgraded(prox_gdf, template_file_path):
    ...
    prox_features_gdf = get_prox_features(prox_gdf, template_file_path)

    # get the bounds to construct an array and raster of which to burn the output into
    bounds = prox_features_gdf.total_bounds
